# ============================================================
# Dysgraphia Detection - ResNet-18 Baseline Test Evaluation
# Experiment 1
#
# Evaluates the BEST frozen-backbone model on the same
# untouched subject-wise test set used for Experiment 2.
#
...
MODEL_PATH = (
    ...
    r"\resnet18_dysgraphia_best.pth"
)
...
print("=" * 60)
print("Dysgraphia Detection - ResNet-18 Baseline Evaluation")
print("Experiment 1")
print("=" * 60)
...
# ============================================================
# 5. LOAD RESNET-18 BASELINE MODEL
# ============================================================

print("\nLoading baseline ResNet-18...")

model = models.resnet18(weights=None)

# Convert first convolution to grayscale
...
print("\n" + "=" * 60)
print("EXPERIMENT 1 TEST EVALUATION COMPLETE")
print("=" * 60)